...
include("plot_conf.jl")

"""
    Routines for diatomic molecules:
        - domain decomposition
        - partition of unity on subdomains
        - exact solvers using finite differences
        - test solvers on Hermite basis
...
# Partition function supported on infinity
